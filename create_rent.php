...
Precio Quincena:<input type="text" name="precio_quin" /><br><br>

Precio Mes:<input type="text" name="precio_mes" /><br><br>
...
$max_T = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Torrevieja'"),ref);
$max_T_colab = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Torrevieja' AND `colab` LIKE '1'"),ref);
$max_G = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Guardamar'"),ref);
$max_G_colab = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Guardamar' AND `colab` LIKE '1'"),ref);
$max_O = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Orihuela Costa'"),ref);
$max_O_colab = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Orihuela Costa' AND `colab` LIKE '1'"),ref);
$max_P = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Pilar de la Horadada' OR `localidad` LIKE 'Mil Palmeras' OR `localidad` LIKE 'Torre de la Horadada'"),ref);
$max_P_colab = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'Pilar de la Horadada' OR `localidad` LIKE 'Mil Palmeras' OR `localidad` LIKE 'Torre de la Horadada' AND `colab` LIKE '1'"),ref);
$max_M = mysql_result(mysql_query("SELECT max(ref) FROM `Rental` WHERE `localidad` LIKE 'San Javier' OR `localidad` LIKE 'Torrepacheco'"),ref);
?>
