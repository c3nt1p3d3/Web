...
$query2 = mysql_query("SELECT * FROM `CasasImages` WHERE `ref` LIKE '" . $referencia . "'");
...
$query3 = mysql_query("SELECT * FROM `CasasImages` WHERE `ref` LIKE '" . $referencia . "' ORDER BY imgpath LIMIT 1, 50");
$query_first_only = mysql_query("SELECT * FROM `CasasImages` WHERE `ref` LIKE '" . $referencia . "' ORDER BY imgpath LIMIT 1");
