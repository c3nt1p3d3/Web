...
<p align='left' style='border-radius: 9px; letter-spacing: 1px; font-size: 16px; background-color: #eeeeee; color: black; padding: 0 10px; line-height: 18px; margin: 0 53px'>
...
<p align='left' style='border-radius: 9px; letter-spacing: 1px; font-weight: bold; font-size: 16px; background-color: #eeeeee; color: black; padding: 0 10px; line-height: 18px; margin: 0 53px'>
...
<?php
echo Translate("Swimmingpool",'').": ".Translate($pool,'')."</p><br>";
?>
...
<?php
echo Translate("Parking",'').": ".Translate($parking,'')."</p><br>";
?>
