...
<!-- ****************************************************** Header ****************************************************** -->
  <div style="background-color: #fe320c; width: 100%; margin-top: 10px; padding-bottom: 10px;  margin-bottom: 5px; text-align: center;">
    <div style="text-align: right; margin: 10px;">

      <br>
      <br>
      <a style="font-size: 45px; color: white; font-weight: bold; float: right; margin-right: 15px;" >
...
?>
  ...
  <div style="padding: 10px; text-align: left;" >
    ...
    <p style="font-size: 23px; margin-top: -5px; font-weight: bold;">
  ...
  <div style="background-color: #fe320c; width: 100%; margin-top: 5px; text-align: center; padding-bottom: 15px; padding-top: 5px; font-size: 18px; font-weight: bold; height: 72px;" >
    <div style="text-align: center; margin-left: 25px; margin-top: -15px; float: left;">
      <br>
      <img width="135px" height="48px" alt="logo" src="http://www.cmproperties.es/images/logo.png" >
